...
import { c as createSvgIcon, r as require$$2, I as IconButton } from "./IconButton.js";
...
import { M as MarkdownRenderer } from "./markdown_renderer.js";
...
const EditorWrapper = default_1$5(Card)({
  width: "100%",
  flex: "auto",
  display: "flex",
...
const EditorHeader = default_1$5(CardHeader)(({
  theme
}) => ({
...
const SidebarBox = default_1$5(Box)({
  flex: 0,
  position: "relative"
});
